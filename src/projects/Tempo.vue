<template>
  <div class="npm run dev">
    ...
    <div class="page-project">
      <div class="project-banner" style="background: url('/images/projects/tempo/banner.png');background-size: cover;">
        <img src="/public/images/rk.jpg" class="project-logo" alt="" title="">
        <div class="project-title">Tempo</div>
      ...
      <div class="page-project-container">
        ...
        <div class="project-stat-container">
          ...
          <div class="project-stat-item">
            <span class="project-stat-item-value">9 month</span>
            <span class="project-stat-item-name">{{ $t('duration') }}</span>
          </div>
          <div class="project-stat-item">
            <span class="project-stat-item-value">95</span>
        ...
        <div class="photo-container">
          <div ref="galleryRef" class="gallery photo-container-elements">
            <div href="/public/images/projects/tempo/1.jpg" class="photo-container-element">
              <img src="/public/images/projects/tempo/1.jpg" />
            </div>
            <div href="/public/images/projects/tempo/2.jpg" class="photo-container-element">
              <img src="/public/images/projects/tempo/2.jpg" />
            </div>
            <div href="/public/images/projects/tempo/3.jpg" class="photo-container-element">
              <img src="/public/images/projects/tempo/3.jpg" />
            </div>
            <div href="/public/images/projects/tempo/4.jpg" class="photo-container-element">
              <img src="/public/images/projects/tempo/4.jpg" />
            </div>
          </div>
        </div>
