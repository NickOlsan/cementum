<template>
  <div class="welcome-container">
    ...
    <div class="welcome-elements">
      ...
      <div class="welcome-element">
        <span class="welcome-element-value">10+</span>
      ...
      <div class="welcome-element">
        <span class="welcome-element-value">124</span>
        <span class="welcome-element-name">{{ $t('welcomeName4') }}</span>
      </div>
    </div>
  </div>
</template>